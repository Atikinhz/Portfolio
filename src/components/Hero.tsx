...
const roles = ["SMM Strategist", "Content Creator", "Growth Expert", "Brand Manager"];
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl">
        ...
        <div className="blur-in text-lg md:text-2xl font-light text-text-primary/90 mb-6">
          {t('hero_role_prefix')}{" "}
        ...
        <div className="blur-in flex flex-wrap justify-center gap-4">
          <button className="group relative rounded-full text-sm px-7 py-3.5 transition-all hover:scale-105 bg-text-primary text-bg hover:bg-bg hover:text-text-primary overflow-hidden">
            ...
            <span className="relative z-10">{t('hero_cta_works')}</span>
          </button>
          
          <button className="group relative rounded-full text-sm px-7 py-3.5 transition-all hover:scale-105 border-2 border-stroke bg-bg text-text-primary hover:border-transparent">
            <div className="absolute inset-0 accent-gradient opacity-0 group-hover:opacity-100 transition-opacity" />
            <div className="absolute inset-[1px] bg-bg rounded-full opacity-0 group-hover:opacity-100 transition-opacity" />
            <span className="relative z-10">{t('hero_cta_reach')}</span>
          </button>
        </div>
      </div>
